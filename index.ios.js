...
export default class reactNativeTabsGradient extends Component {
  ...
  render() {
    ...
    return (
      <LinearGradient key="gradientWrap" start={[0.0, 0.25]} end={[0.5, 1.0]} locations={[0.25, 0.75]} colors={['rgba(108, 1, 4, 0.2)', 'rgba(108, 1, 4, 1)']} style={[styles.tabbarView, this.props.style, this.state.keyboardUp && styles.hidden]}>
